...
Insert into pg_user (ID,ACTIVE_FLAG,AGE,CREATION_TIME_STAMP,EMAIL,FIRST_NAME,LAST_NAME,LAST_UPDATED_TIME_STAMP,MOBILE_NUMBER,PASSWORD,USERNAME,role,gender) values (1,1,0,null,null,'Satish','Verma',null,8744956983,'123','sat',10,4);
Insert into pg_user (ID,ACTIVE_FLAG,AGE,CREATION_TIME_STAMP,EMAIL,FIRST_NAME,LAST_NAME,LAST_UPDATED_TIME_STAMP,MOBILE_NUMBER,PASSWORD,USERNAME,role,gender) values (2,1,0,null,null,'Deepali','Jain',null,96523589652,'123','dee',7,5);
Insert into pg_user (ID,ACTIVE_FLAG,AGE,CREATION_TIME_STAMP,EMAIL,FIRST_NAME,LAST_NAME,LAST_UPDATED_TIME_STAMP,MOBILE_NUMBER,PASSWORD,USERNAME,CREATED_BY,LAST_UPDATED_BY,GENDER,ROLE) values (3,1,0,null,null,'Vishal','Tyagi',null,85412589652,'123','vis',2,null,4,7);
